...
struct ContentView: View {
    let inputOrder = [["(",")","mc","m+","m-","mr","AC","+/-","%","÷"],
                      ["2nd","x^2","x^3","x^y","e^x","10^x","7","8","9","×"],
                      ["1/x","2√x","y√x","In","log>10","4","5","6","-"],
                                ...
                                Button() {
                                    ...
                                    if row != "0" {
                                        ZStack {
                                            ...
                                            } else if ["2nd","x^2","x^3","x^y","e^x","10^x"] .contains(row) && ["1/x","2√x","y√x","In","log>10"] .contains(row) && ["1/x","2√x","y√x","In","log>10"] .contains(row){
                                                Color.yellow
                                            } else {
                                                Color.blue
                                            }
