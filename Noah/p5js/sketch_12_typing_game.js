...
let textColor = []
let score = 0
let bonuswords = 'Incomprehensibilities Interdisciplinary Inconsequential subdermatoglyphic (uncopyrightable) sesquipedalianism disestablishment counterintuitive Connecticutian Massachusetts electromaganecticspectrum parkerisbad noahandsichengaresmart jiowehfihkejkgfqwv'
let bonis = 100
let bonus = false;
let bonusx = 0;
let bonusword = '';
