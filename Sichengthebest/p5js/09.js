...
function draw(){
    ...
    for (let index = 0; index < length; index++) {
        for (let index = 0; index < length; index++) {
            xs.push(random(getArray(235,width-100)));
        }
        for (let index = 0; index < length; index++) {
            words.push(random(paragraph[difficultyindex].split(' ')));
        }
        fill(0);
    ...
    if (bonus == true) {
        ...
        if (bonusx >= width) {
            ...
            bonusrgb = [random(getArray(5,245)),random(getArray(5,245)),random(getArray(5,245))];
        }
